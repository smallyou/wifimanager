...
#warning --------------------------------自己增加的方法
    if ([self.delegate respondsToSelector:@selector(userClickedOnPieChart:atIndex:atTouchPoint:)]) {
        [self.delegate userClickedOnPieChart:self atIndex:index atTouchPoint:touchLocation];
    }
